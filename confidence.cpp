...
conf confidence::getconfidence(const double d[])
{
	//avg, size, edge
	conf c;
	value(c, d[0]);
...
void confidence::value(conf& c, const double d)
{
...
void confidence::size(conf& c, const double d)
{
...
void confidence::edges(conf& c, const double d)
{
